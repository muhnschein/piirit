...
fn the_top_of_the_view_is_the_first_message_in_the_chat() {
    let temp = std::env::temp_dir().join(format!("piiri-qml-paging-{}", std::process::id()));
    ...
    unsafe {
        ...
        std::env::set_var("PIIRI_FAKE_INFO_FIRST", "1");
    }
