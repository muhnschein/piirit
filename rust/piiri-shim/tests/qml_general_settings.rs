...
fn the_settings_page_writes_what_the_app_reads() {
    ...
    for (label, expected) in [
        ...
        ("app-enter-key", "/apps/harbour-piiri/enter_sends"),
        ("enter-default", "false"),
        ("enter-switch", "false"),
        ("flip-enter", "ok"),
        ("enter-on", "true"),
        ...
        ("app-quality-key", "/apps/harbour-piiri/media_quality"),
        ...
        ("flip-back", "ok"),
        ("links-off", "false"),
        ("app-markdown-key", "/apps/harbour-piiri/markdown_mode"),
        ("app-links-key", "/apps/harbour-piiri/clean_links"),
        ("app-download-key", "/apps/harbour-piiri/download_limit"),
        (
            "app-deletion-key",
            "/apps/harbour-piiri/delete_device_after",
        ),
        (
            "app-notification-key",
            "/apps/harbour-piiri/notification_detail",
        ),
        (
            "app-mentions-key",
