...
fn a_relay_given_up_on_is_neither_reused_nor_kept() {
    let temp = std::env::temp_dir().join(format!("piiri-profile-retry-{}", std::process::id()));
