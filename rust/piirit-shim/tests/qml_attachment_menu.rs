    ...
    Item {
        ...
        function load(url) {
            ...
            rows.append({
                ...
                file_path: '/tmp/piirit-menu/TODO.md',
                file_name: 'TODO.md',
            ...
            rows.append({
                ...
                sender_name: 'Ada', sender_color: '#00875a',
                is_forwarded: false, quote_text: '', quote_author: '',
                file_path: '/tmp/piirit-menu/checkers.xdc',
            ...
            rows.append({
                ...
                sender_name: 'Ada', sender_color: '#00875a',
                is_forwarded: false, quote_text: '', quote_author: '',
                file_path: '/tmp/piirit-menu/photo.jpg',
                file_name: 'photo.jpg',
            ...
            rows.append({
                ...
                sender_name: 'Ada', sender_color: '#00875a',
                is_forwarded: false, quote_text: '', quote_author: '',
                file_path: '/tmp/piirit-menu/clip.mp4',
                file_name: 'clip.mp4',
            ...
            list.item.saveRequested.connect(function(fileUrl, fileName) {
                raised += 'save:' + fileUrl + ':' + fileName + ';'
            })
            return 'ok'
        }
...
fn a_message_carrying_a_file_offers_to_open_it_and_to_keep_it() {
    ...
    assert_eq!(
        value("raised"),
        "open:TODO.md:File;save:file:///tmp/piirit-menu/TODO.md:TODO.md;",
        "the menu did not say which file it meant, what the sender called \
         it, or what kind it is: a page opens a file by its kind, and a \
         copy is named as the sender named it. {context}"
    );
}
